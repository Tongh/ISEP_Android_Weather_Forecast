...
public class locationUtil {
    ...
    static public void getlocation(AppCompatActivity appCompatActivity, Context context) {
        ...
        if (providerList.contains(LocationManager.GPS_PROVIDER)) {
            ...
            Toast.makeText(appCompatActivity, "No location provider to use",
        ...
        if (ActivityCompat.checkSelfPermission(appCompatActivity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(appCompatActivity, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            appCompatActivity.registerForActivityResult(
                    ...
                    result -> {
                        if (result) {
                            getlocation(appCompatActivity, context);
                            Toast.makeText(appCompatActivity, "Success", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(appCompatActivity, "Failure", Toast.LENGTH_SHORT).show();
                        }
